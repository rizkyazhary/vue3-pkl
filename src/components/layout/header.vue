            ...
            <header class="header navbar navbar-expand-sm">
                <ul class="navbar-item theme-brand flex-row text-center">
                    ...
                    <li class="nav-item theme-text">
                        <router-link to="/" class="nav-link"> MAXMAR </router-link>
                    </li>
                </ul>
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled">
                            ...
                            <li>
                                <router-link to="/apps/mailbox">Mailbox</router-link>
                            </li>
                            <li>
                                <router-link to="/apps/todo-list">Todo List</router-link>
                            </li>
                            <li>
                                <router-link to="/apps/notes">Notes</router-link>
                            </li>
                            <li>
                            ...
                            <li class="sub-sub-submenu-list">
                                ...
                                <ul class="collapse list-unstyled sub-submenu">
                                    ...
                                    <li>
                                        <router-link to="/apps/invoice/preview">Preview</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/invoice/add">Add</router-link>
                                    </li>
                                    <li>
                            ...
                            <li>
                                <router-link to="/apps/calendar">Calendar</router-link>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled">
                            ...
                            <li>
                                <router-link to="/components/accordions">Accordions</router-link>
                            </li>
                            <li>
                            ...
                            <li>
                                <router-link to="/components/countdown">Countdown</router-link>
                            </li>
                            <li>
                                <router-link to="/components/counter">Counter</router-link>
                            </li>
                            <li>
                                <router-link to="/components/sweetalert">Sweet Alerts</router-link>
                            </li>
                            <li>
                                <router-link to="/components/timeline">Timeline</router-link>
                            </li>
                            <li>
                                <router-link to="/components/notifications">Notifications</router-link>
                            </li>
                            <li>
                                <router-link to="/components/media-object">Media Object</router-link>
                            </li>
                            <li>
                                <router-link to="/components/list-group">List Group</router-link>
                            </li>
                            <li>
                                <router-link to="/components/pricing-table">Pricing Tables</router-link>
                            </li>
                            <li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled">
                            <li>
                                <router-link to="/elements/alerts">Alerts</router-link>
                            </li>
                            <li>
                                <router-link to="/elements/avatar">Avatar</router-link>
                            </li>
                            <li>
                                <router-link to="/elements/badges">Badges</router-link>
                            </li>
                            <li>
                                <router-link to="/elements/breadcrumbs">Breadcrumbs</router-link>
                            </li>
                            <li>
                                <router-link to="/elements/buttons">Buttons</router-link>
                            </li>
                            <li>
                                <router-link to="/elements/buttons-group">Button Groups</router-link>
                            </li>
                            <li>
                                <router-link to="/elements/color-library">Color Library</router-link>
                            </li>
                            <li>
                                <router-link to="/elements/dropdown">Dropdown</router-link>
                            </li>
                            <li>
                                <router-link to="/elements/infobox">Infobox</router-link>
                            </li>
                            <li>
                                <router-link to="/elements/jumbotron">Jumbotron</router-link>
                            </li>
                            <li>
                                <router-link to="/elements/loader">Loader</router-link>
                            </li>
                            <li>
                            ...
                            <li>
                                <router-link to="/elements/progress-bar">Progress Bar</router-link>
                            </li>
                            <li>
                                <router-link to="/elements/search">Search</router-link>
                            </li>
                            <li>
                        ...
                        <ul class="collapse submenu list-unstyled">
                            ...
                            <li class="sub-sub-submenu-list">
                                ...
                                <ul class="collapse list-unstyled sub-submenu">
                                    ...
                                    <li>
                                        <router-link to="/tables/striped">Striped Table</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/tables/order-sorting">Order Sorting</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/tables/multi-column">Multi Column</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/tables/multiple-tables">Multiple Tables</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/tables/alt-pagination">Alt. Pagination</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/tables/custom">Custom</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/tables/range-search">Range Search</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/tables/export">Export</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/tables/live-dom-ordering">Live DOM ordering</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/tables/miscellaneous">Miscellaneous</router-link>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled">
                            <li>
                                <router-link to="/forms/basic">Basic</router-link>
                            </li>
                            <li>
                                <router-link to="/forms/input-group">Input Group</router-link>
                            </li>
                            <li>
                                <router-link to="/forms/layouts">Layouts</router-link>
                            </li>
                            <li>
                            ...
                            <li>
                                <router-link to="/forms/select2">Select2</router-link>
                            </li>
                            <li>
                                <router-link to="/forms/touchspin">TouchSpin</router-link>
                            </li>
                            <li>
                                <router-link to="/forms/checkbox-radio">Checkbox &amp; Radio</router-link>
                            </li>
                            <li>
                                <router-link to="/forms/switches">Switches</router-link>
                            </li>
                            <li>
                                <router-link to="/forms/wizards">Wizards</router-link>
                            </li>
                            <li>
                            ...
                            <li>
                                <router-link to="/forms/markdown-editor">Markdown Editor</router-link>
                            </li>
                            <li>
                                <router-link to="/forms/date-picker">Date &amp; Range Picker </router-link>
                            </li>
                            <li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled">
                            <li>
                                <router-link to="/pages/helpdesk">Helpdesk</router-link>
                            </li>
                            <li>
                            ...
                            <li>
                                <router-link to="/pages/faq2">FAQ 2</router-link>
                            </li>
                            <li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled">
                            <li>
                                <router-link to="/dragndrop">Drag and Drop</router-link>
                            </li>
                            <li>
                                <router-link to="/widgets">Widgets</router-link>
                            </li>
                            <li>
                                <router-link to="/charts/apex-chart">Charts</router-link>
                            </li>
                            <li>
                                <router-link to="/font-icons">Font Icons</router-link>
                            </li>
                            <li>
